...
for i in range(0 ,len(list_2)):
    ...
    list_2[i] = list_2[min]
    list_2[min] = b
print(f"ПЕРВЫЙ СОРТИРОВАННЫЙ СПИСОК:{list_1}")
print(f"ВТОРОЙ СОРТИРОВАННЫЙ СПИСОК:{list_2}") 
print(f'количество сравнений в первом списке:{score1}')
print(f'количество сравнений во втором списке:{score}')